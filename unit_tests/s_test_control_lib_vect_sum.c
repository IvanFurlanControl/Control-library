...
#define S_FUNCTION_NAME s_test_control_lib_vect_sum
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetOutputPortWidth(S, 0, VECT_H); // no. of outputs
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    t_system_var test_vect_1[VECT_H] = {1,4,3};
    t_system_var test_vect_2[VECT_H] = {2,8,7};
    t_system_var test_res[VECT_H];

    vects_sum(test_res, test_vect_1, test_vect_2, VECT_H);
