...
#define S_FUNCTION_NAME s_test_control_lib_poly_ctr
...
#define AW_IDX 1
#define AW_PARAM(S) ssGetSFcnParam(S,AW_IDX)
...
t_polynomial_controller test_transfer_function_aw;
...
static void mdlInitializeConditions(SimStruct *S)
{
    InputRealPtrsType uPtrs = ssGetInputPortRealSignalPtrs(S,0);
    {
        ...
        t_system_var anti_windup_ = *mxGetPr(AW_PARAM(S));
        ...
        init_test = polynomial_controller_object_create(order_test, anti_windup, num_test, den_test, &test_transfer_function_aw);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
     ...
     **/
    out_k = polynomial_controller_output_calc(in_k, 100, -100, &test_transfer_function_aw);
    //y[0] = (real_T)(test_out);
    y[0] = (real_T)(out_k);
}
